...
from graf.config_dmednerf import get_data, build_models, save_config, update_config, build_lr_scheduler
...
if __name__ == '__main__':
    ...
    # Dataset
    train_dataset, hwfr, render_poses, times = get_data(config)
